...
cd %USERPROFILE%
if exist .ssh (echo ssh [42;37m[OK]  [40;33m) else (echo 41;37m[ERREUR] [40;33mssh manquant & mkdir .ssh)
cd %USERPROFILE%.ssh
if exist id_rsa cd %USERPROFILE% & mkdir backup-ssh & copy /y %USERPROFILE%.ssh\* %USERPROFILE%\backup-ssh\ 
if exist id_rsa.pub cd %USERPROFILE% & mkdir backup-ssh & copy /y %USERPROFILE%.ssh\* %USERPROFILE%\backup-ssh\ 
copy /y
